...
function google_fonts() {
    return 'https://fonts.googleapis.com/css?family=' . urlencode('Martel:300,600,700|Montserrat:300,500');
}

add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('sage/main.css', asset_path('styles/main.css'), false, null);
    wp_enqueue_style('fonts/google', \App\google_fonts(), false, null);
...
/** 
 * View Google Fonts in editor.
 */
add_filter('mce_css', function($sheets) {
    return "$sheets," . \App\google_fonts();
});
